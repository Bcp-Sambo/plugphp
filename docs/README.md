...
| [Core API Reference](core-api.md) | Every `core/` class: Config, Database, Auth, View/`e()`, Url, Crypto, Tracking, Branding, Nav, Router, Module, Settings, Mailer, Upload, Updater |
