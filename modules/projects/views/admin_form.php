...
?>
<a class="backlink" href="<?= url('/admin/projects') ?>">&larr; Projects</a>
        ...
        <div class="upload">
            <div class="upload__thumb ratio ratio-16x9">
                <?php if (!empty($project['featured_image'])): ?>
                    <img src="<?= asset((string) $project['featured_image']) ?>" alt="Current featured image" loading="lazy">
    ...
    <div class="field">
        ...
        <div class="gallery-grid">
            <?php foreach ($gallery as $i => $img): ?>
                <div class="ratio ratio-1x1"><img src="<?= asset($img) ?>" alt="Gallery image <?= e((string) ($i + 1)) ?>" loading="lazy"></div>
            <?php endforeach; ?>
