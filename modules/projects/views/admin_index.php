...
<div class="admin-toolbar">
    <form method="post" action="<?= url('/admin/projects/visibility') ?>">
    ...
    <a class="btn btn-primary btn-sm" href="<?= url('/admin/projects/new') ?>">
            ...
            <tbody>
                <?php foreach ($projects as $p): ?>
                    <tr>
                        ...
                        <td class="td-actions">
                            <a href="<?= url('/admin/projects/' . (string) $p['id'] . '/edit') ?>">Edit</a>
                            <a class="danger" href="<?= url('/admin/projects/' . (string) $p['id'] . '/delete') ?>">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
