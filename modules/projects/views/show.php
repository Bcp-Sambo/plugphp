...
<article>
    <div class="container" style="max-width:900px;padding-top:clamp(40px,5vw,64px)">
        <a class="backlink" href="<?= url('/projects') ?>">&larr; All projects</a>
    ...
    <div class="container" style="margin-top:28px">
        <div class="ratio ratio-16x9">
            <?php if (!empty($project['featured_image'])): ?>
                <img src="<?= asset($project['featured_image']) ?>" alt="<?= e($project['title']) ?>" loading="lazy">
            <?php else: ?>
    ...
    <div class="container container--prose" style="padding-top:36px">
        ...
        <?php if (!empty($project['project_url'])): ?>
            <a class="btn btn-secondary" style="margin-top:26px" href="<?= url($project['project_url']) ?>" rel="noopener noreferrer" target="_blank">Visit project
            ...
            <div class="grid grid--gallery" style="margin-top:16px">
                <?php foreach ($gallery as $i => $img): ?>
                    <div class="ratio ratio-1x1">
                        <img src="<?= asset($img) ?>" alt="<?= e($project['title']) ?> — image <?= e((string) ($i + 1)) ?>" loading="lazy">
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
